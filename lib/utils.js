...
MongooseUtils.prototype.flatten = function flattenNormalizedSchema(){
  return flattenOut(this.schema);
};

MongooseUtils.prototype.filter = function filterNormalizedSchema(cb){
